var piggish = angular.module('piggish',['ngRoute']);  //piggish is a variable. We are storing the value returned by the angular.module() function here
 piggish.config(function ($routeProvider) {   //.config() is a function that allows us to set-up our app in some way and in this We pass it a function as the parameter and $routeProvider is an object defined in ngRoute  which allows us to set-up routes
	$routeProvider
...
piggish.controller('mainController',function($scope, $location) {    //here in the first argument, we are passing the name of the controller we want to create And in the second argument, we are passing the function we want the controller to do .if we write in console that console.log(piggish) then we will find that it is a object with no. of properties
...
piggish.controller('loginController',function($scope , $location) {     //controller defined in class login
...
piggish.controller('restaurantController',function($scope,$routeParams,$http) {    //params is parameter and $http bcoz for ingredients we have to use clarifai and with the help of http we make http request without the help of jquery
    $scope.foodListApp = function(){
    		$location.url('favouritesfoodlist')
    	                             }
    	$scope.ingredients = [];
...
piggish.controller('foodListController',function($scope,$http){

 // first request using api
   $scope.list1 = [];
   var data = '{"inputs":[{"data":{"image":{"url":"' +'https://tse2.mm.bing.net/th?id=OIP.R6Y1yAxnp-z9WLbjv0ph-AEsDI&pid=15.1&P=0&w=250&h=167'+ '"}}}]}'
   $http({
     'method' : 'POST',
     'url': 'https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs',
     'headers': {
 ...
 // second request
   $scope.list2 = [];
   var data = '{"inputs":[{"data":{"image":{"url":"' +'https://a2zfoodnames.files.wordpress.com/2014/05/cd058-blogporkchickenafritada1.jpg?w=320&h=212'+ '"}}}]}'
   $http({
     'method' : 'POST',
     'url': 'https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs',
     'headers': {
 ...
 // Third request
   $scope.list3 = [];
   var data = '{"inputs":[{"data":{"image":{"url":"' +'https://tse4.mm.bing.net/th?id=OIP.v1B4UvnwZqxBWVqroGmUlwEsCo&pid=15.1&P=0&w=296&h=167'+ '"}}}]}'
   $http({
     'method' : 'POST',
     'url': 'https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs',
     'headers': {
 ...
 // Fourth request
   $scope.list4 = [];
   var data = '{"inputs":[{"data":{"image":{"url":"' +'http://i.ndtvimg.com/i/2016-03/pasta-625_625x350_81459347494.jpg'+ '"}}}]}'
   $http({
     'method' : 'POST',
     'url': 'https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs',
     'headers': {
 ...
 // Fifth request
   $scope.list5 = [];
   var data = '{"inputs":[{"data":{"image":{"url":"' +''+ '"}}}]}'
   $http({
     'method' : 'POST',
     'url': 'https://api.clarifai.com/v2/models/bd367be194cf45149e75f01d59f77ba7/outputs',
     'headers': {
   ...
   var imagesList=[{
     ...
     name:'Cake',
     img:'https://tse4.mm.bing.net/th?id=OIP.v1B4UvnwZqxBWVqroGmUlwEsCo&pid=15.1&P=0&w=296&h=167'
   },{
     name:'Pasta Con Pomodoro E Basilli',
     img:'http://i.ndtvimg.com/i/2016-03/pasta-625_625x350_81459347494.jpg'
   },{
     name:'Sundae scoops',
